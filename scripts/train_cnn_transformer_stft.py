...
# 参数
# =========================
DATA_DIR = "data/splits_stft"
RESULT_DIR = os.path.join("results", "cnn_transformer_stft")
MODEL_DIR = os.path.join("models", "cnn_transformer_stft")
...
def main():
    ...
    meta = {
        "model_name": "CNN+Transformer(STFT)",
        "epochs": EPOCHS,
        "batch_size": BATCH_SIZE,
        "lr": LR,
        "num_runs": NUM_RUNS,
    ...
    with open(os.path.join(RESULT_DIR, "summary.txt"), "w", encoding="utf-8") as f:
        f.write("CNN+Transformer(STFT) Results\n")
